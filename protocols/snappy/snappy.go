...
func NewSnappyDialer(dialer protocols.Dialer) (protocols.Dialer, error) {
	return snappyDialer{dialer}, nil
}

func NewSnappyListenConfig(listenConfig protocols.ListenConfig) (protocols.ListenConfig, error) {
